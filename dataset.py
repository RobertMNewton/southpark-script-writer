...
def _init_scripts(load_from_file: str = "southpark_tokens_short.json"):
    """
    ...
    """
    global _scripts, _scripts_tokens, tokeniser
    _scripts = []
    ...
    _scripts_tokens = better_tokens.text_to_ids(_scripts, tokeniser, truncate_to=max_episode_size)
